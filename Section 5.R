...
# --------------------------- Bonus: Exercise 3 --------------------------------
# Write a variance function for the Horvitz-Thompson estimator for the case that
# Prof. Aronow mentioned where there is a closed-form solution. Also compare it
# to a bootstrap variance.
